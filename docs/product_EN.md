...
- Question cards and generated follow-ups must pick the answer form that fits the concrete question intent: open text, binary stance, single choice, multi-select, ranked, evidence judgment, or experiment-plan answers. The app must not force every answer into a pro/con shape.
