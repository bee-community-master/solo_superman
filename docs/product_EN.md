...
- Long clarification sessions must show question progress with generated, answered, total follow-up, open follow-up, topic coverage, and remaining follow-up budget counts.
...
- Research-generated additional questions must re-enter the Decision Queue as answerable, source-traceable follow-up debt, not remain hidden as evidence-card notes only; run-status polling that ingests provider evidence must refresh the Queue and Research surfaces that expose that debt.
