...
- Auto implementation worker controls must show Codex runtime readiness, execution mode, account status, live-turn flag, manual handoff availability, and ledger-import fallback before an operator tries to run a local worker job.
