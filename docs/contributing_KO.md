...
- General release readiness 변경은 `docs/release-readiness_KO.md`, `docs/release-readiness_EN.md`, `docs/release-readiness.example.json`, `pnpm verify:release-readiness`, `pnpm release:evidence-checklist`, `pnpm release:evidence-bundle`, `pnpm verify:release-evidence-bundle`을 함께 갱신합니다.
