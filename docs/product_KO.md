...
- 긴 clarification session에서는 생성됨, 지금 답할 질문, 다음 질문, 막힘, 답변됨, 전체 후속 질문, 남은 후속 질문, topic coverage, 남은 follow-up budget count를 질문 진행률에 보여야 합니다. Maintainer는 credential-free clarification pipeline smoke로 아이디어 intake부터 초기 스펙 분석, 활성 질문 묶음, 답변 제출, follow-up/research debt, Planning Handoff blocker까지 이어지는 질문 루프가 끊기지 않았는지 검증할 수 있어야 합니다.
