...
- [ ] Phase 2.5는 `34-phase2.5-browser-automation-preview-contract.md`에 연결되고 comparative dry-run, DelegationRiskGate, no-execution boundary를 요구한다.
