...
| `DeleteServicePageUsePermissionArtifacts` | delete retained service page-use prompt/redaction/screenshot/log artifact refs from the latest permission while preserving audit metadata and user-visible deletion evidence |
