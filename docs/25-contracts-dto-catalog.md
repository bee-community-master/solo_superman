...
- Desktop UI/view-model은 final `PlanningHandoffArtifactDto`에서만 `Planning-ready` label을 사용하고, blocker artifact에서는 blocker class, required next action, residual risk, safe preview refs를 별도 report로 표시한다.
