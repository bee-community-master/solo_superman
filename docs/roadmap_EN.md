...
- #99, #100, #101, #102, #103, #104, #105, #106, #108, #110, and #112 exposed stage tick/lifecycle controls, manual worker completion, planned worker ledger-doc binding, exact planned worker ledger docs inside bounded worker plans, manual ledger-import binding to those planned docs, current-stage worker control scoping, and operator UI/manual recovery for worker ledger imports.
