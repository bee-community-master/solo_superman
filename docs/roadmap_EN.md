...
- #99, #100, #101, #102, #103, #104, #105, and #106 exposed stage tick/lifecycle controls, manual worker completion, planned worker ledger-doc binding, and exact planned worker ledger docs inside bounded worker plans.
