...
- #99, #100, #101, #102, #103, #104, #105, #106, #108, #110, #112는 stage tick/lifecycle control, manual worker completion, planned worker ledger-doc binding, exact planned worker ledger doc의 bounded worker plan 저장/표시, manual ledger import의 planned doc binding, current-stage worker control scoping, worker ledger import의 operator UI/manual recovery를 노출했습니다.
