...
describe("#105 local install/run verification docs", () => {
  ...
  it("documents the release evidence checklist for external release gates", () => {
    ...
    expect(readme).toContain("required nested ready-release command 실행 기록");
    ...
    expect(englishReadme).toContain("required nested ready-release command records");
    ...
    expect(readFileSync("docs/release-readiness_KO.md", "utf8")).toContain("nested ready-release command 실행 기록");
    ...
    expect(readFileSync("docs/release-readiness_EN.md", "utf8")).toContain("records every nested ready-release command");
    expect(runbook).toContain("nested ready-release command 실행 기록");
    ...
    expect(readFileSync("docs/troubleshooting_EN.md", "utf8")).toContain("every nested ready-release command is recorded");
