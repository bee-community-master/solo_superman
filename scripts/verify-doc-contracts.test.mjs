...
`);
  ...
  it("includes simplified contributor docs in web/local realignment scans", () => {
    ...
    expect(WEB_REALIGNMENT_SCAN_PATHS).toContain("docs/windows-real-device_KO.md");
    expect(WEB_REALIGNMENT_SCAN_PATHS).toContain("docs/signed-packages_KO.md");
    expect(WEB_REALIGNMENT_SCAN_PATHS).toContain("docs/signed-package-release_KO.md");
  });
