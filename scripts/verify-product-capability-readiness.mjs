...
const REQUIRED_CAPABILITY_BEHAVIOR_SNIPPETS = new Map([
  ...
  [
    ...
    [
      ...
      "Opt-in live-web research verification",
      "source-traced result import",
      "source-quality ranking",
      "idea-relevant institutional/statistical public evidence",
      "drops unrelated search-engine noise",
      "fallback candidates may be retained only as review-gated evidence",
      "evidence matrices and evidence packs",
      "Max simultaneous research runs",
      "Max research runs per session",
      "markdown memory",
      "wider follow-up research",
      "generated follow-up research tasks",
      "Research-generated follow-up questions",
      "sourceQueueItemId-linked planned research tasks",
      "queued research_evidence_effect wait work",
      "answer-form variety",
      ...
      "ranked_choice",
      "evidence_judgment",
      "evidence-derived or domain-specific candidate lists",
      "direct idea-fit first-customer input",
      "instead of inventing generic founder/operator choices"
    ]
  ],
  [
    "planning-readiness-gates",
  ...
  [
    ...
    [
      ...
      "live worker-job verification",
      "skipped, blocked, or passed evidence",
      "Planning-derived PR-sized issue docs",
      "issueManagement.planningIssueDocs",
      "separate PR issue sequence tracker",
      "selected planningIssueId",
      ...
      "single-session product loop",
      "same-session worker execution",
      "generated-product target paths",
      "generated-product changed-file",
      "single-session live-web product loop",
      "single-session live implementation",
