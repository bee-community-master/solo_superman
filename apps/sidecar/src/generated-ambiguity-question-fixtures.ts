...
function question(input: {
  ...
  return {
    ...
    ...(ambiguityRoutingPath === "current_research"
      ? {
          researchQuestion: input.researchQuestion ?? `${input.summary}에 대한 공개 사례와 다른 관점은 무엇인가?`,
          suggestedResearchTask: input.suggestedResearchTask ??
            `${input.summary} 관련 공개 사례, 커뮤니티 글, 후기에서 근거와 다른 관점, 남은 판단을 분리합니다.`
        }
      : {
...
export function generatedFounderQuestionSet(intensity: BusinessCriticIntensity = "balanced") {
  const baseQuestions = [
    ...
    question({
      ...
      questionText: "창업자가 질문에 답하고 나면 어떤 기획서 조각이 생겨야 하나요?",
      ambiguityDimension: "scope"
    }),
    question({
      sectionRef: "JTBD / Use Case",
      topicKey: "case_response_shape",
      summary: "창업자 유형별 대응 방식 미정",
      questionText: "초보 창업자, 문서가 있는 창업자, 팀이 있는 창업자는 무엇이 달라야 하나요?",
      ambiguityDimension: "scope"
    }),
    question({
    ...
    question({
      ...
      questionText: "창업자 기획 도구를 가장 먼저 보여줄 고객군은 누구인가요?",
      expectedAnswerType: "choice",
      answerOptions: [
        option("paid_interview_founder", "유료 인터뷰를 준비하는 1인 창업자"),
        option("spec_drafting_founder", "제품 기획 초안을 만드는 창업자"),
    ...
    question({
      ...
      summary: "첫 창업자 제품 범위 미정",
      questionText: "창업자 기획 도구 첫 버전에서 반드시 확인할 기능은 무엇인가요?",
      expectedAnswerType: "choice",
    ...
    question({
      ...
      uncertaintyType: "missing_con_evidence",
      summary: "창업자 대체재 불만족 근거 부족",
      questionText: "창업자는 현재 어떤 방식으로 제품 기획을 만들고 어디서 충분하지 않다고 느끼나요?",
    ...
    question({
      ...
      summary: "창업자 구매자와 사용자 분리 미확인",
      questionText: "창업자 기획 도구를 실제로 쓰는 사람과 비용을 승인하는 사람은 같은가요?",
      expectedAnswerType: "choice"
    }),
    question({
      ...
      uncertaintyType: "missing_con_evidence",
      summary: "창업자 지불 망설임 이유 미확인",
      questionText: "창업자가 이 제품에 돈을 내기 망설일 가장 큰 이유는 무엇인가요?",
    ...
    question({
      ...
      summary: "창업자 첫 확인 행동 미정",
      questionText: "이번 주 어떤 창업자에게 결과를 보여주고 반응을 확인할까요?",
      expectedAnswerType: "experiment",
      ambiguityRoutingPath: "current_research"
    }),
    question({
      ...
      uncertaintyType: "vague",
      summary: "창업자 반복 사용 신호 미정",
      questionText: "창업자가 제품을 다시 쓴다고 볼 수 있는 행동 신호는 무엇인가요?"
    }),
    question({
      sectionRef: "Value Proposition",
      topicKey: "value_prop_switching_reason",
      uncertaintyType: "decision_required",
      summary: "창업자 대체재 전환 이유 미정",
      questionText: "창업자가 기존 노트와 문서 대신 이 제품으로 옮겨올 이유는 무엇인가요?",
    ...
    question({
      ...
      severity: "medium",
      summary: "창업자 주요 주장 근거 균형 부족",
      questionText: "창업자 기획 도구의 주요 주장을 뒷받침하는 단서와 다른 관점 중 무엇이 비어 있나요?",
      expectedAnswerType: "evidence",
      ambiguityRoutingPath: "current_research",
      possibleRoutes: ["research_needed", "missing_con_evidence"]
    }),
    question({
      ...
      uncertaintyType: "decision_required",
      severity: "medium",
      summary: "창업자 첫 버전 제외 범위 미정",
      questionText: "첫 버전에서 의도적으로 만들지 않을 범위는 무엇인가요?",
      expectedAnswerType: "choice",
    ...
    question({
      ...
      uncertaintyType: "unsupported",
      severity: "medium",
      summary: "창업자 모집 채널 근거 부족",
      questionText: "창업자를 어디서 현실적으로 모집할 수 있나요?",
      expectedAnswerType: "evidence",
      ambiguityRoutingPath: "current_research",
    ...
    question({
      ...
      uncertaintyType: "unsupported",
      severity: "medium",
      summary: "창업자 제품 구현 범위 적합성 미확인",
      questionText: "현재 리소스로 창업자 기획 도구의 첫 기능을 구현할 수 있나요?"
    }),
    question({
      ...
      questionText: "이 제품이 창업자의 기획 정리 문제를 더 잘 풀 수 있는 근거는 무엇인가요?",
      expectedAnswerType: "evidence",
      ambiguityRoutingPath: "current_research",
      possibleRoutes: ["research_needed", "spec_update_candidate"]
    }),
    question({
      ...
      severity: "low",
      summary: "창업자 제품 운영 위험 경계 미정",
      questionText: "창업자 기획 도구에서 확인해야 할 보안, 법률, 운영상 걱정거리는 무엇인가요?",
    ...
    question({
      ...
      questionText: "창업자는 어떤 상황에서 제품 기획 도구를 써야 하나요?"
    })
  ];
  const strongQuestions = [
    question({
      ...
      uncertaintyType: "missing_con_evidence",
      summary: "창업자 유료 전환 판단 미확인",
      questionText: "창업자가 제품에 돈을 내지 않을 가장 큰 이유는 무엇인가요?",
      expectedAnswerType: "experiment",
      ambiguityDimension: "assumption_pressure",
  ...
  const investorQuestions = [
    question({
      ...
      uncertaintyType: "missing_con_evidence",
      summary: "창업자 가격 판단 근거 부족",
      questionText: "어떤 가격을 보여주면 창업자가 망설일까요?",
      expectedAnswerType: "experiment",
      ambiguityDimension: "assumption_pressure",
    ...
    question({
      ...
      uncertaintyType: "unsupported",
      summary: "창업자 시장 타이밍 근거 부족",
      questionText: "왜 지금 창업자의 제품 기획 문제가 더 급해졌나요?",
      expectedAnswerType: "evidence",
      ambiguityRoutingPath: "current_research",
      businessCriticIntensityMinimum: "investor_grade",
      businessCriticPressureKind: "investor_pressure_pass",
  ...
  return {
    ...
    questions: [
      ...
      question({
        ...
        ambiguityRoutingPath: "current_research",
        researchQuestion:
          "동물병원, 펫보험, 보호자 커뮤니티, 장례·말기 케어에서 기록 문제가 드물거나 기존 방식으로 충분히 해결되는 사례와 문제 빈도와 강도가 아직 측정되지 않음의 단서는 무엇인가?",
        suggestedResearchTask:
          "동물병원, 펫보험, 보호자 커뮤니티, 장례·말기 케어 자료에서 보호자 기록 문제 근거와 다른 관점, 남은 판단을 분리합니다."
      }),
      question({
        sectionRef: "Target Customer",
        topicKey: "primary_customer_narrowing",
        uncertaintyType: "vague",
        summary: "첫 반려동물 보호자 유형이 넓음",
        questionText: "반려동물 관리 앱을 가장 먼저 보여줄 보호자 유형은 누구인가요?",
        expectedAnswerType: "choice",
        answerOptions: [
          option("first_pet_guardian", "첫 반려동물을 키우는 보호자"),
          option("senior_chronic_pet_guardian", "노령·만성질환 반려동물 보호자"),
          option("multi_pet_household", "여러 마리를 함께 키우는 보호자")
        ]
      }),
      question({
        sectionRef: "Value Proposition",
        topicKey: "payment_hesitation_reason",
        uncertaintyType: "missing_con_evidence",
        summary: "반려동물 보호자 지불 망설임 이유 미확인",
        questionText: "반려동물 보호자가 의료·보험·장례 기록 앱에 돈을 내기 망설일 이유는 무엇인가요?",
        expectedAnswerType: "experiment",
        ambiguityDimension: "assumption_pressure",
        possibleRoutes: ["question", "missing_con_evidence", "deferred"],
        answerOptions: [
          option("pet_guardian_price_test", "반려동물 보호자 가격 확인"),
          option("pet_guardian_privacy_test", "반려동물 보호자 개인정보 우려 확인"),
          option("pet_guardian_existing_app_test", "반려동물 보호자 기존 앱 비교")
        ]
      }),
      question({
        sectionRef: "Current Alternatives",
        topicKey: "alternative_dissatisfaction_gap",
        uncertaintyType: "missing_con_evidence",
        summary: "반려동물 보호자 대체재 불만족 근거 부족",
        questionText: "반려동물 보호자는 메모, 사진첩, 병원 앱 중 어디서 충분하지 않다고 느끼나요?",
        expectedAnswerType: "evidence",
        ambiguityRoutingPath: "current_research",
        researchQuestion:
          "동물병원, 펫보험, 보호자 커뮤니티, 장례·말기 케어에서 대체재 만족/불만족 근거와 기존 대체재가 충분히 좋아서 전환하지 않는 사례는 무엇인가?",
        suggestedResearchTask:
          "동물병원, 펫보험, 보호자 커뮤니티, 장례·말기 케어 자료에서 대체재 만족/불만족 근거, 기존 대체재가 충분히 좋은 사례, 한계와 다른 관점, 남은 판단을 분리합니다.",
        possibleRoutes: ["question", "research_needed", "missing_con_evidence"],
        answerOptions: [
          option("pet_guardian_notes", "보호자 메모 앱"),
          option("pet_guardian_photo_album", "보호자 사진첩"),
          option("pet_guardian_clinic_app", "동물병원 앱")
        ]
      }),
      question({
        sectionRef: "Validation Plan",
        topicKey: "first_validation_experiment",
        summary: "반려동물 보호자 첫 확인 행동 미정",
        questionText: "이번 주 어떤 반려동물 보호자에게 의료 기록 화면을 보여주고 반응을 확인할까요?",
        expectedAnswerType: "experiment",
        ambiguityRoutingPath: "current_research",
        answerOptions: [
          option("senior_pet_guardian_interview", "노령 반려동물 보호자 인터뷰"),
          option("insurance_pet_guardian_test", "보험 청구 보호자 확인"),
          option("multi_pet_guardian_review", "여러 마리 보호자 화면 리뷰")
        ]
      }),
      question({
        sectionRef: "Success Criteria",
        topicKey: "success_metric_measurability",
        uncertaintyType: "vague",
        summary: "반려동물 보호자 반복 사용 신호 미정",
        questionText: "반려동물 보호자가 다시 쓴다고 볼 수 있는 의료·보험 기록 행동 신호는 무엇인가요?"
      }),
      question({
        sectionRef: "Target Customer",
        topicKey: "buyer_user_split",
