...
const POST_PHASE3_PR03_CHATGPT_DELEGATION_ROUTE_ID_SET = new Set<string>(
  POST_PHASE3_PR03_CHATGPT_DELEGATION_ROUTE_IDS
);
const POST_PHASE3_PR04_CHATGPT_DELEGATION_RUN_ROUTE_ID_SET = new Set<string>(
  POST_PHASE3_PR04_CHATGPT_DELEGATION_RUN_ROUTE_IDS
);
const POST_PHASE3_PR05_SERVICE_PAGE_PERMISSION_ROUTE_ID_SET = new Set<string>(
  POST_PHASE3_PR05_SERVICE_PAGE_PERMISSION_ROUTE_IDS
);
...
const IMPLEMENTATION_ROUTE_GROUPS = [
  ...
  {
    routeIds: POST_PHASE3_PR05_SERVICE_PAGE_PERMISSION_ROUTE_ID_SET,
  ...
  {
    routeIds: POST_PHASE3_PR03_CHATGPT_DELEGATION_ROUTE_ID_SET,
