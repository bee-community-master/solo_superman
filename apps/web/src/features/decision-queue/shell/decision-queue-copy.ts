...
const EN_COPY = {
  ...
  questions: {
    ...
    codexLoginDescription: "The local sidecar checks the Codex CLI account before backend question or research preview work starts.",
    ...
    codexLoginCommandLabel: "If needed, run this in Terminal",
...
const JA_COPY: typeof EN_COPY = {
  ...
  questions: {
    ...
    codexLoginDescription: "ローカルsidecarは、backendの質問やリサーチpreviewを始める前にCodex CLIアカウント状態を確認します。",
    ...
    codexLoginCommandLabel: "必要ならTerminalで実行",
...
const KO_COPY: typeof EN_COPY = {
  ...
  questions: {
    ...
    codexLoginDescription: "로컬 sidecar는 backend 질문 또는 리서치 preview를 시작하기 전에 Codex CLI 계정 상태를 확인합니다.",
    ...
    codexLoginCommandLabel: "필요하면 Terminal에서 실행",
