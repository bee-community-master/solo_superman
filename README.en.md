...
- Remaining general-release work: create and verify macOS/Windows installer packages with real signing/notarization credentials, macOS/Windows device updater rollback verification against signed artifacts, and Windows real-device verification
