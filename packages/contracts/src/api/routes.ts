...
export const API_ROUTE_CATALOG = [
  ...
  {
    routeId: "recordAutoImplementationPullRequestMutation",
    clientName: "recordAutoImplementationPullRequestMutation",
    method: "POST",
  ...
  {
    routeId: "createAutoImplementationWorkerJob",
    clientName: "createAutoImplementationWorkerJob",
    method: "POST",
  ...
  {
    routeId: "runAutoImplementationWorkerJob",
    clientName: "runAutoImplementationWorkerJob",
    method: "POST",
    path: "/api/v1/sessions/:sessionId/auto-implementation-runs/:runId/worker-jobs/:jobId/run",
    commandType: "none",
    implementedInPr01: false
  },
  {
    routeId: "advanceAutoImplementationWorkerStage",
    clientName: "advanceAutoImplementationWorkerStage",
    method: "POST",
    path: "/api/v1/sessions/:sessionId/auto-implementation-runs/:runId/worker-jobs/:jobId/advance-stage",
    commandType: "none",
    implementedInPr01: false
  },
  {
